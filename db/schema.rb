...
ActiveRecord::Schema.define(version: 20171223002057) do
  ...
  create_table "test_notes", force: :cascade do |t|
    ...
    t.index ["student_id"], name: "index_test_notes_on_student_id"
    t.index ["test_id"], name: "index_test_notes_on_test_id"
  end
